...
pipeline_lr=pickle.load(open("lr_pipeline.pkl","rb"))
...
if nav=="match analysis":
    ...
    chk=(not disable) and first_innings and second_innings and venue and target and runs and overs and wickets
    col1,col2,col3,col4,col5=st.columns([1,1,1,1,1])
    with col3: predict=st.button("Predict",disabled=(not chk))
    if predict:
        lose,win=pipeline_lr.predict_proba(user_data)[0]
